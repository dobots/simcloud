...
def path_list():
    ...
    path_points.append([6.5, -3.5]) #1.room right bottom corner
    path_points.append([8.8, -0.5]) #1.room left top corner
    path_points.append([8.8, 2])    #2.room door
    path_points.append([8.8, 4])   #7
    path_points.append([11, 4])    #8
    path_points.append([11, 2])    #9
    path_points.append([8.8, 2])   #10
    path_points.append([8.8, -0.5]) #1.room left top corner
    path_points.append([5.5, -0.5]) #1.room left bootom corner
    path_points.append([5.5, 2])    #3.room door
    path_points.append([5.5, 4])   #14
    path_points.append([4.7, 4])   #15
    path_points.append([4.7, 2])   #16

    #Go back
    path_points.append([5.8, 2]) #3.room door
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        position_msg.pose.position.z = 1.1
